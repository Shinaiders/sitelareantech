...
const servicesWithCards: IServiceItemsProps[] = [
...

  {
    ...
    title: "Juridico",
    description:
      "Oferecemos consultoria jurídica especializada para empresas e startups do setor tecnológico. Nossa equipe entende como proteção de dados, propriedade intelectual, compliance digital e contratos tecnológicos."
  },
];
